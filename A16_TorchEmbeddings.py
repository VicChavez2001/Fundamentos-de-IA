...
data = {
        ...
        "token": ["Dunas2", "es", "grandiosa", "Godzila"],
...
plt.text(df.w1[1]-0.2, df.w2[1]+0.1, df.token[1],
         horizontalalignment='left',
         size='medium',
         color='black',
         weight='semibold')

plt.text(df.w1[2]-0.2, df.w2[2]+0.1, df.token[2],
         horizontalalignment='left',
         size='medium',
         color='black',
         weight='semibold')

plt.text(df.w1[3]-0.2, df.w2[3]+0.1, df.token[3],
         horizontalalignment='left',
         size='medium',
         color='black',
         weight='semibold')
...
#   Embedding de pytorch pero se le tienen que dar
#   transpuestos
#====================================================
